...
describe('API Integration Tests', () => {
  ...
  describe('Playlist Endpoints', () => {
    ...
    it('GET /playlists should return all playlists', () => {
      const mockResponse = {
        playlistsByUser: {
          ...
          user2: [
            { name: 'User2 Playlist', status: 'private', songs: [] },
          ],
        },
      };
    ...
    it('PATCH /playlist/rename should update playlist name', () => {
      let playlist = { name: 'Old Name', status: 'private' as const, songs: [] };
    ...
    it('PATCH /playlist/setStatus should update playlist status', () => {
      let playlist: { name: string; status: 'private' | 'public'; songs: [] } = { name: 'Test', status: 'private', songs: [] };
