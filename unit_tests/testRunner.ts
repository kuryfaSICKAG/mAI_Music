...
class TestRunner {
  ...
  private printHeader(): void {
    ...
    console.log(
      "║         🎵 mAI_Music Unit Test Runner 🎵                        ║",
    );
    console.log(
      "║  Executing comprehensive test suite for all modules             ║",
    );
    console.log(
      "╚════════════════════════════════════════════════════════════════╝",
    );
  ...
  private printSummary(success: boolean): void {
    ...
    console.log(colors.blue + "║  Test Modules:" + colors.reset);
    ...
    testFiles.forEach((file) => {
      ...
      console.log(
        colors.blue + `║  ${icon} ${this.padString(name, 52)}` + colors.reset,
      );
    });
